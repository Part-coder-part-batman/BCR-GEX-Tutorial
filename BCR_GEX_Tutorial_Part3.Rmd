...
|------|-------------|----------|
| `P1_LN_bcr_data.tsv` | Part 1 | `P1_LN/Output/` |
| `P1_PT_bcr_data.tsv` | Part 1 | `P1_PT/Output/` |
| `integrated_S7_annotated.rds` | Part 2 | `RDS_Objects/` |
| `BCR_viz_functions.R` | This tutorial | `ROOT_DIR/` |
